...
exports.BDGet = exports.BDDel = exports.BDPut = exports.queueLog = exports.extensionState = exports.queueRemove = exports.queuePause = exports.queueAdd = exports.originateCall = void 0;
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    manager = require('asterisk-manager')(CONN.port, CONN.host, CONN.user, CONN.password, CONN.event);
                    manager_action = util_1.promisify(manager.action);
                    pbx_extension = { type: '', extension: '', status: '' };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    e_4 = _a.sent();
                    manager.disconnect();
                    return [2 /*return*/, { response: "error", data: e_4 }];
                case 4: return [2 /*return*/];
            }
        });
    });
